...
const fileContents = '-- To demonstrate the documentation and definition file formats, this demo includes a `demo` module with one function and three global types.\nlocal fake_val = demo.fake_function({foo = "hello", bar = 123})\nlocal wrong = math.abs("hello, world")\nfunction broken\n  return wrong\nwithout end';
...
const createWasmConnection = async function(encoding : string) {
    try {
